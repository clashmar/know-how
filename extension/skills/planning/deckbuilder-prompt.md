...
When showing the deckbuilder result to the human:

> **Important:** Do not paste a bare `file://...` URL. Always wrap it in a short markdown link label like `[Open spec](file://...)` so it stays clickable in narrow terminals.
